...
Let $\mathcal{B}$ denote a $\sigma$-algebra that contains $X$, and we index each with $n$. Then the $\sigma$-algebra generated by $X$ is defined as $\sigma(X) = \cap_{i\in \mathbb{N}} \mathcal{F}_i$.
